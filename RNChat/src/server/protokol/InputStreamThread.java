...
/**
 * Erstellt einen neuen Thread, der auf dem InputStream liest und prüft ob die übermittelte Nachricht dem {@code<message>}-Format entspricht.
 * Wenn nicht, werden die Nachrichten verworfen..
 * @param inStream
 * @param queue
 */
